...
class TestListarPedidos:
    ...
    def test_quando_pedido_nao_encontrado_um_erro_deve_ser_retornado(self,
                                                                     cliente,
    ...
    def test_quando_encontrar_pedido_codigo_ok_deve_ser_retornado(self,
                                                                  cliente,
                                                                  sobreescreve_recuperar_itens_por_pedido):
        sobreescreve_recuperar_itens_por_pedido([])
        resposta = cliente.get(
    ...
    def test_quando_encontrar_pedido_deve_retornar_itens(self, cliente,
        ...
        itens = [
            Item(sku='1', description='Item 1',
                 image_url='http://url.com/img1', reference='ref1',
                 quantity=1),
            Item(sku='2', description='Item 2',
                 image_url='http://url.com/img2', reference='ref2',
                 quantity=2),
        ]
    ...
    def test_quando_fonte_de_pedidos_falha_um_erro_deve_ser_retornado(self,
                                                                      cliente,
                                                                      sobreescreve_recuperar_itens_por_pedido):
