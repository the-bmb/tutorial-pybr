...
def tratar_erro_pedido_nao_encontrado(request: Request,
                                      exc: PedidoNaoEncontradoError):
...
def tratar_erro_falha_de_comunicacao(request: Request,
                                     exc: FalhaDeComunicacaoError):
    return JSONResponse(status_code=HTTPStatus.BAD_GATEWAY, content={
